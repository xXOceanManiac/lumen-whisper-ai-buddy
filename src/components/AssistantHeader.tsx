...
const AssistantHeader = ({ onOpenSettings, settings, isProcessing }: AssistantHeaderProps) => {
  return (
    <header className="bg-white shadow-sm flex items-center justify-between p-4 sticky top-0 z-10">
      ...
      <div className="flex items-center space-x-3">
        {isProcessing && (
          <div className="text-sm text-lumen-gray animate-pulse">
            Processing...
          </div>
        )}
        ...
        <button
          ...
          className="p-2 rounded-full hover:bg-lumen-lightGray transition-colors"
